...
<html class="no-js" lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <a href="/">
        <img 
            height="60" 
            style="transform: scale(3.5) translateX(15px); object-fit: cover;" 
    ...
    <img 
        height="60" 
        style="transform: scale(2.5) translateX(10px); object-fit: cover;" 
        src="{{ asset('frontend/assets/img/logo/logo.png') }}" 
        alt=""
    >
    <div class="footer-about-2" style="margin-top: 10px;">
    <p>
            Aromaterapi merupakan seni penyembuhan alami <br>
            yang memanfaatkan minyak esensial untuk membantu <br>
            relaksasi, memperbaiki suasana hati, dan kesehatan holistik.
        </p>
    </div>
</div>
                            ...
                            <div class="footer-info-wrapper-3">
                                <div class="footer-address-furniture">
                                    ...
                                    <div class="footer-info-content3">
                                        <p>Jln industri kapal dalam no 100 A<br>Cimanggis, kota depok, jawa barat</p>
                                    </div>
                                </div>
                                <div class="footer-address-furniture">
                                    <div class="footer-info-icon3">
                                ...
                                <div class="footer-address-furniture">
                                    ...
                                    <div class="footer-info-content3">
                                        <p><a href="#"> arum.official24@gmail.com</a> <br><a href="#"> arum.official24@gmail.com</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
